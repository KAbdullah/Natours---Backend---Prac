    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        ...
        case 1:
          res = _context2.v;
          if (res.data.status = 'success') {
            window.location.reload(true); //adding true as a parameter insures reload of server not cache
          }
          _context2.n = 3;
          break;
        case 2:
...
var displayMap = exports.displayMap = function displayMap() {
  ...
  locations.forEach(function (loc) {
    var latLng = [loc.coordinates[1], loc.coordinates[0]];
    points.push(latLng);
    L.marker(latLng).addTo(map).bindPopup("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
      autoClose: false
    }).openPopup();
  });
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          session = _context.v;
          _context.n = 2;
          return Stripe('pk_test_51RxIoTFHqAUjfa2OA6vkNeTdsiHwSTCRAPNfl1yaG18aqXnXjS3nxfRoTN0pppkFlubdAKp3ECLGYl14NfXg3e2T00WOQ4ShBE');
        case 2:
          stripe = _context.v;
          _context.n = 3;
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  // .dataset accesses attricutes prfixed with data-
